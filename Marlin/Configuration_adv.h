...
// @section bltouch
   ...
   */
  #define BLTOUCH_HS_MODE true // @josh enable
...
//
// #define ASSISTED_TRAMMING // @josh disable
...
//#define LCD_BACKLIGHT_TIMEOUT_MINS 1  // (minutes) Timeout before turning off the backlight
  ...
  #define PROBE_OFFSET_WIZARD       // Add a Probe Z Offset calibration option to the LCD menu @josh enable
 ...
 */
#define BABYSTEPPING //@josh enable
  ...
  #define BABYSTEP_ZPROBE_OFFSET          // Combine M851 Z and Babystepping @josh enable
 ...
 */
#define HOST_ACTION_COMMANDS //@josh enable all
